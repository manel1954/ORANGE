...
mate-terminal --geometry 101x8+1277+665 --title=DMR2YSF -x ./DMR2NXDN DMR2NXDN.ini & 
sleep 1
cd /home/orangepi/MMDVMHost
mate-terminal --geometry 101x8+1277+797 --title=MMDVMDMR2YSF -x ./MMDVMHost MMDVMDMR2NXDN.ini &
sleep 1
cd /home/orangepi/NXDNClients/NXDNGateway
mate-terminal --geometry 101x9+1277+987 --title=YSFGATEWAY -x ./NXDNGateway NXDNGateway.ini

...
mate-terminal --geometry 102x8+1274+665 --title=DMR2YSF -x ./DMR2YSF DMR2YSF.ini &

cd /home/orangepi/MMDVMHost
mate-terminal --geometry 104x9+1274+787 --title=MMDVMDMR2YSF -x ./DMR2YSF MMDVMDMR2YSF.ini &

cd /home/orangepi/YSFClients/YSFGateway
mate-terminal --geometry 106x9+1274+987 --title=YSFGATEWAY -x ./YSFGateway YSFGateway.ini

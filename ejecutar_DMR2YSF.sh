...
mate-terminal --geometry 101x8+1264+665 --title=DMR2YSF -x ./DMR2YSF DMR2YSF.ini &

cd /home/orangepi/MMDVMHost
mate-terminal --geometry 101x8+1265+792 --title=MMDVMDMR2YSF -x ./DMR2YSF MMDVMDMR2YSF.ini &

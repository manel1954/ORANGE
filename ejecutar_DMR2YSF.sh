...
mate-terminal --geometry 104x8+1151+665 --title=DMR2YSF -x ./DMR2YSF DMR2YSF.ini &

cd /home/orangepi/MMDVMHost
mate-terminal --geometry 104x8+1151+792 --title=MMDVMDMR2YSF -x ./DMR2YSF MMDVMDMR2YSF.ini &

cd /home/orangepi/YSFClients/YSFGateway
mate-terminal --geometry 104x9+1151+987 --title=YSFGATEWAY -x ./YSFGateway YSFGateway.ini
